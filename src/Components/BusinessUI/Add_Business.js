...
const AddBusiness = ()=>{
    ...
    const getCandidates = async ()=>{
        ...
        const {data} = await axios({
            method:'post',
            url:`https://stormy-ridge-57109-180df8a72b27.herokuapp.com/https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=${formattedPlace}&inputtype=textquery&key=${API_KEY}`,
            headers:{
    ...
    const fetchPlaces = async (candidate)=>{
        ...
        const {data} = await axios({
            method:'post',
            url:`https://stormy-ridge-57109-180df8a72b27.herokuapp.com/https://maps.googleapis.com/maps/api/place/details/json?place_id=${place_id}&key=${API_KEY}`,
            headers:{
                "Content-Type":"application/json",
                "Access-Control-Allow-Origin": "*",
                "Access-Control-Allow-Methods": 'HEAD, GET, POST, PUT, PATCH, DELETE',
